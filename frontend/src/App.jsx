    ...
    return (
        <div className="min-h-screen" style={{ backgroundColor: "#F9EAE8" }}>
            ...
            <footer
                ...
                style={{ borderTop: "1px solid #EDE0DF", backgroundColor: "#F9EAE8", color: "#2C2C2C", opacity: 0.5 }}
            >
        ...
        >
            ...
            <nav className="space-x-7 text-sm font-sans font-medium">
                {[
                    ...
                    <Link key={item.label} to={item.to} style={{ color: "#2C2C2C" }}>
                        {item.label}
                    </Link>
                ))}
            ...
            <BrowserRouter>
                ...
                <Routes>
                    ...
                    <Route path="/admin/packages" element={
                        <ProtectedAdminRoute><AdminPackagesPage /></ProtectedAdminRoute>
                    } />
                    ...
                    <Route path="/admin/vendors" element={
                        <ProtectedAdminRoute><AdminVendorDashboard /></ProtectedAdminRoute>
                    } />

                    <Route path="/admin/feedback" element={
                        <ProtectedAdminRoute><AdminFeedbackPage /></ProtectedAdminRoute>
                    } />

                    {/* ── Admin Payments ── */}
                    <Route path="/admin/payments" element={
                        <ProtectedAdminRoute><PaymentList /></ProtectedAdminRoute>
                    } />

                    <Route path="/admin/payments/create" element={
                        <ProtectedAdminRoute><PaymentForm /></ProtectedAdminRoute>
                    } />

                    <Route path="/admin/payments/:id/edit" element={
                        <ProtectedAdminRoute><PaymentForm /></ProtectedAdminRoute>
                    } />
