...
export default function PaymentForm() {
  ...
  // ── Route base: admin stays on /admin/payments, users on /payments
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // ── Go back to the right list (admin or public)
      navigate(base);
    } catch {
      ...
      <div className="min-h-screen bg-[#F9EAE8] font-serif">
        ...
        <div className="max-w-3xl mx-auto px-6 py-10">
            ...
            <div className="px-8 py-6 grid grid-cols-2 gap-5 border-b border-[#EDE0DF]">
              ...
              <div>
                ...
                <div className="relative">
                  <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#C9A84C] font-medium text-sm font-sans">$</span>
                  <input
                      type="number"
                      min="0"
                      step="0.01"
          ...
          <div className="flex items-center justify-between mt-6">
            ...
            {/* Cancel — goes back to the correct list */}
            <button
                onClick={() => navigate(base)}
